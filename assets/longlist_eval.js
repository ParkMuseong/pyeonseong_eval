...
(function () {
  ...
  document.getElementById("meta").textContent =
    (META.sheet ? META.sheet + " · " : "") + "총 " + DATA.length + "개 작품 · 10점 척도";
  ...
  function render() {
    ...
    idxs.forEach(function (i) {
      ...
      html += '<td class="merged cat" rowspan="3">' + esc(w.분야 || "-") + "</td>";
      ...
      html += '<tr class="detail-row" id="detail-' + i + '" data-work="' + i + '" style="display:none"><td colspan="12">' +
        ...
        "<dt>주체</dt><dd>" + esc(w.주체 || "-") + "</dd>" +
        "<dt>참여</dt><dd>" + esc(w.참여 || "-") + "</dd>" +
        "<dt>설명</dt><dd>" + esc(w.설명 || "-") + "</dd>" +
        "</dl>" +
  ...
  function exportCSV() {
    ...
    var head = ["콘텐츠명", "분야", "유형", "세부유형", "장르", "국가", "공개일", "공개월주차", "플랫폼",
      "평가자", "화제성", "독창성", "근접성", "영향성", "평점", "총점",
      "화제성사유", "독창성사유", "근접성사유", "영향성사유",
      "주체", "참여", "설명", "AI평가사유", "검증", "검증사유"];
